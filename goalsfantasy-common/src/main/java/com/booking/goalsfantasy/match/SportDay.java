...
public class SportDay {
	...
	public SportDay(String sportDayId, Integer sportDaySequence) {
		super();
		this.sportDayId = sportDayId;
		this.sportDaySequence = sportDaySequence;
	}

	public String getSportDayId() {
		return sportDayId;
	}

	public void setSportDayId(String sportDayId) {
		this.sportDayId = sportDayId;
	}
